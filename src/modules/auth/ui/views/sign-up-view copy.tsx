      ...
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
                        ...
                        <div className="fgrid gap-3">
                            ...
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="text" placeholder="Type your name here..." {...field}/>
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <div className="fgrid gap-3">
                            ...
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="email" placeholder="Type your email here..." {...field}/>
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
          ...
          <div className="bg-radial from-green-700 to-green-900 relative hidden md:flex flex-col gap-y-4 items-center justify-center">
            ...
            <p className="text-2xl font-semibold text-white">Voxa</p>
          </div>
        </CardContent>
      </Card>
